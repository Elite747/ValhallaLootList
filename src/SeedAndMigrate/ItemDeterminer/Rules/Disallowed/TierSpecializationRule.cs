...
namespace ValhallaLootList.SeedAndMigrate.ItemDeterminer.Rules.Disallowed
{
    internal class TierSpecializationRule : SimpleRule
    {
        private static readonly Dictionary<uint, Specializations> _tierSpecs = new()
        {
            ...
            // Priest
            // Tier 4
            [29054] = Specializations.HealerPriest, // Light-Mantle of the Incarnate (Priest)
            [29050] = Specializations.HealerPriest, // Robes of the Incarnate (Priest)
            [29053] = Specializations.HealerPriest, // Trousers of the Incarnate (Priest)
            ...
            // Tier 5
            [30153] = Specializations.HealerPriest, // Breeches of the Avatar (Priest)
            [30152] = Specializations.HealerPriest, // Cowl of the Avatar (Priest)
            [30151] = Specializations.HealerPriest, // Gloves of the Avatar (Priest)
            [30154] = Specializations.HealerPriest, // Mantle of the Avatar (Priest)
            [30150] = Specializations.HealerPriest, // Vestments of the Avatar (Priest)
            ...
            // Tier 6
            [31068] = Specializations.HealerPriest, // Breeches of Absolution (Priest)
            [31063] = Specializations.HealerPriest, // Cowl of Absolution (Priest)
            [31060] = Specializations.HealerPriest, // Gloves of Absolution (Priest)
            [31069] = Specializations.HealerPriest, // Mantle of Absolution (Priest)
            [31066] = Specializations.HealerPriest, // Vestments of Absolution (Priest)
            [34527] = Specializations.HealerPriest, // Belt of Absolution (Priest)
            [34562] = Specializations.HealerPriest, // Boots of Absolution (Priest)
            [34435] = Specializations.HealerPriest, // Cuffs of Absolution (Priest)
