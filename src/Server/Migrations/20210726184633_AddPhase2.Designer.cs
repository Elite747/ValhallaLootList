...
namespace ValhallaLootList.Server.Migrations
{
    ...
    [Migration("20210726184633_AddPhase2")]
    partial class AddPhase2
    {
            ...
            modelBuilder.Entity("ValhallaLootList.Server.Data.PhaseDetails", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = (byte)2,
                            StartsAt = new DateTimeOffset(new DateTime(2021, 8, 31, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, -4, 0, 0, 0))
                        });
                });
