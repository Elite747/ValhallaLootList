        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScheduleId = table.Column<string>(type: "varchar(255) CHARACTER SET utf8mb4", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Raids", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Raids_RaidTeamSchedules_ScheduleId",
                        column: x => x.ScheduleId,
                        principalTable: "RaidTeamSchedules",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BossId = table.Column<string>(type: "varchar(255) CHARACTER SET utf8mb4", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BossKills", x => new { x.BossId, x.RaidId });
                    table.ForeignKey(
                        name: "FK_BossKills_Encounters_BossId",
                        column: x => x.BossId,
                        principalTable: "Encounters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BossKills_Raids_RaidId",
                        column: x => x.RaidId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BossKillId = table.Column<string>(type: "varchar(255) CHARACTER SET utf8mb4", nullable: false),
                    ItemId = table.Column<uint>(type: "int unsigned", nullable: false),
                    ...
                    BossKillBossId = table.Column<string>(type: "varchar(255) CHARACTER SET utf8mb4", nullable: false),
                    BossKillRaidId = table.Column<string>(type: "varchar(255) CHARACTER SET utf8mb4", nullable: false),
                    WinnerId = table.Column<string>(type: "varchar(255) CHARACTER SET utf8mb4", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Drops", x => new { x.BossKillId, x.ItemId });
                    table.ForeignKey(
                        name: "FK_Drops_BossKills_BossKillBossId_BossKillRaidId",
                        columns: x => new { x.BossKillBossId, x.BossKillRaidId },
                        principalTable: "BossKills",
                        principalColumns: new[] { "BossId", "RaidId" },
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CharacterId = table.Column<string>(type: "varchar(255) CHARACTER SET utf8mb4", nullable: false),
                    DropBossKillId = table.Column<string>(type: "varchar(255) CHARACTER SET utf8mb4", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DropPasses_Drops_DropBossKillId_DropItemId",
                        columns: x => new { x.DropBossKillId, x.DropItemId },
                        principalTable: "Drops",
                        principalColumns: new[] { "BossKillId", "ItemId" },
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DropPasses_DropBossKillId_DropItemId",
                table: "DropPasses",
                columns: new[] { "DropBossKillId", "DropItemId" });

            migrationBuilder.CreateIndex(
                name: "IX_Drops_BossKillBossId_BossKillRaidId",
                table: "Drops",
                columns: new[] { "BossKillBossId", "BossKillRaidId" });
