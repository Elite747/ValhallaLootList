    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DropId = table.Column<string>(type: "varchar(255) CHARACTER SET utf8mb4", nullable: false),
                    CharacterId = table.Column<string>(type: "varchar(255) CHARACTER SET utf8mb4", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DropPasses", x => new { x.CharacterId, x.DropId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DropPasses_DropEncounterKillRaidId_DropEncounterKillEncounte~",
                table: "DropPasses",
